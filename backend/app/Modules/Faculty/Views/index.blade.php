                    ...
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <div align="right">
                                ...
                                @if(Input::has('title') || Input::has('university_id'))
                                    <a href="{{ URL::to('/faculties') }}" type="submit" class="btn btn-danger" style="color: black;"><i class="fa fa fa-refresh"></i></a>
                                @endif
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="university_id">
                                            ...
                                            <option value="{{ $university->id }}" {{ Input::get('university_id') == $university->id ? 'selected': '' }}>{{ $university->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <ul class="nav navbar-right " style="padding-top: 1%">
                                @if(\Helper::checkRules('add-faculty'))
                                    <a href="{{'/faculties/add'}}" class="btn btn-default" style="color: black;"><i class="fa fa fa-plus"></i> Add New</a>
                                @endif
                                <a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                            </ul>
                        </div>
                            ...
                            <tr id="tableRaw{{ $value->id }}">
                                ...
                                <td width="150px" align="center">
                                    @if(\Helper::checkRules('edit-faculty'))
                                        <a href="{{ URL::to('/faculties/edit/' . $value->id) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                    @endif
                                    @if(\Helper::checkRules('delete-faculty'))
                                        <a onclick="deleteFaculty('{{ $value->id }}')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
...
@section('script')
    <script src="{{ URL::asset('assets/components/faculties.js')}}"></script>
@stop()
