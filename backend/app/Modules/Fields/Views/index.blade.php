                    ...
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <div align="right">
                                ...
                                @if(Input::has('title'))
                                    <a href="{{ URL::to('/fields') }}" type="submit" class="btn btn-danger" style="color: black;"><i class="fa fa fa-refresh"></i></a>
                                @endif
        ...
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    <div class="row">
                        <div class="col-md-6">
                            <h3>Fields<small> Total : {{ $data->pagination->total_count }}</small></h3>
                        </div>
                        <div class="col-md-6">
                            <ul class="nav navbar-right " style="padding-top: 1%">
                                @if(\Helper::checkRules('add-field'))
                                    <a href="{{URL::to('/fields/add')}}" class="btn btn-default" style="color: black;"><i class="fa fa fa-plus"></i> Add New</a>
                                @endif
                                <a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                            </ul>
                        </div>
                            ...
                            <tr id="tableRaw{{ $value->id }}">
                                ...
                                <td width="150px" align="center">
                                    @if(\Helper::checkRules('edit-field'))
                                        <a href="{{ URL::to('/fields/edit/' . $value->id) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                    @endif
                                    @if(\Helper::checkRules('delete-field'))
                                        <a onclick="deleteField('{{ $value->id }}')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
...
@section('script')
    <script src="{{ asset('assets/components/fields.js')}}"></script>
@stop()
