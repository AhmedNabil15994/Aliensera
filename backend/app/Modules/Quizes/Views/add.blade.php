...
@section('otherhead')
<link rel="stylesheet" type="text/css" href="{{ URL::to('/assets/css/add-quiz.css') }}">
@endsection
@section('content')
    <div class="">
        <div class="row" >
            <form method="post" action="{{ URL::to('/quizes/create/') }}" class="form-horizontal form-label-left">
                <div class="col-md-12 col-sm-12 col-xs-12" >
                    <div class="x_panel" >
                        <div class="x_title">
                            <strong>Add Quiz information</strong>
                            <ul class="nav navbar-right panel_toolbox">
                                <div align="right">
                                    <a href="{{ URL::to('/quizes') }}" class="btn btn-round btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                                    @if(\Helper::checkRules('add-quiz'))
                        ...
                        <div class="x_content">
                            <div class="row" style="min-height: 80px">
                                ...
                                <div class="col-xs-9 col-sm-8 col-md-4 ">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <p class="gender">
                                                Inside Lessons <input type="radio" class="flat" name="quiz_type" {{ old('quiz_type') == 0 ? 'checked' : ''  }} value="0"/>
                                                Between Lessons <input type="radio" class="flat" name="quiz_type" {{ old('quiz_type') == 1 ? 'checked' : ''  }} value="1"/>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12" style="padding-left: 0;">
                                    ...
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>List Questions <span>Total:</span><span class="total_questions"> 0</span></h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                                            </ul>
                                            <div class="clearfix"></div>
